...
<template>
  <div class="practice-section">
    ...
    <input
      type="text"
      v-model="text1"
      @input="console.log('input', text1)"
      @compositionstart="console.log('composition start')"
      @compositionupdate="console.log('composition update')"
      @compositionend="console.log('composition end')"
